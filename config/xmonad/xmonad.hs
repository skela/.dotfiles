...
lockScreen :: String
lockScreen = "betterlockscreen -l dim --off 5"
...
myStartupHook :: X ()
myStartupHook = do
    spawn "killall xwinwrap polybar trayer"
    ...
    -- bar
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar workspaces"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar music"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar keyboard"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar date"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar time"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar volume"
    -- spawn "sleep 0.3 && polybar -c ~/.config/xmonad/polybar battery"

    -- spawn "~/.config/xmobar/xmobar_transparent_spawner.sh &"

    spawn "trayer --edge top --align right --widthtype request --padding 8 --SetDockType true --SetPartialStrut true --expand true --monitor 0 --transparent true --alpha 0 --tint 0x000000  --height 22 --iconspacing 2 &"
...
myWorkspaces = [" home ", " dev ", " sys ", " doc ", " chat ", " email ", " mus ", " vm ", " gfx ", " web "]
-- myWorkspaceIndices = M.fromList $ zipWith (,) myWorkspaces [1..] -- (,) == \x y -> (x,y)
-- myWorkspaceIndices = [(" home ",1), (" dev ",2), (" sys ",3), (" doc ",4), (" chat ",5), (" email ",6), (" mus ",7), (" vm ",8), (" gfx ",9), (" web ",10)]    
myWorkspaceIndices = ["1","2","3","4","5","6","7","8","9","0"]
-- myWorkspaceIndices.last = 0
...
myManageHook = composeAll
     ...
     , title =? "Mozilla Firefox"     --> doShift ( myWorkspaces !! 10 )
     , className =? "Brave-browser"   --> doShift ( myWorkspaces !! 10 )
...
myKeys =
    ...
    -- KB_GROUP Layouts
        ...
        -- , ("M-S-l", sendMessage PreviousLayout)           -- Switch to next layout
